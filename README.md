...
## API Preview
![Swagger UI Screenshot](docs/swagger-demo.PNG)
...
- [ ] 📊 Richer project/task filtering and reporting
- [ ] 🧾 CRUD endpoints for backlog management
- [ ] 🧠 Centralized Serilog sinks (console + Seq)
- [ ] 🧪 xUnit coverage for TaskService
- [ ] 🧱 Export Mermaid architecture diagram to PNG for the docs bundle
- [x] 📸 Embed Swagger UI screenshot for recruiters
...
### 👨‍💻 Author
**Semir Ahmed Mahmed Harun**  
🧭 Backend & Survey Engineer · GIS & Content Creator  
📍 Norway  
🔗 [GitHub](https://github.com/Semir-Harun) | [LinkedIn](https://linkedin.com/in/semir-harun)

> 💬 “QuestBoard is my clean-architecture showcase — scalable, secure, and production-minded.”
